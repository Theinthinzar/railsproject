  ...
  def new
    @chmsg = TChannelMessage.select("distinct t_channel_messages.chmsg_id,m_channels.channel_name ,m_users.user_name ,t_channel_messages.chmessage,t_channel_messages.created_at")
                            .joins("join m_users on t_channel_messages.chsender_id=m_users.user_id 
                                    join h_chmessage_replies on h_chmessage_replies.chmsg_id=t_channel_messages.chmsg_id
    ...
    @chmsgthrd = HChmessageReply.select("h_chmessage_replies.chmsg_id,m_users.user_name,h_chmessage_replies.chthreadmsg,h_chmessage_replies.created_at")
                                .joins("join m_users on h_chmessage_replies.chreplyer_id=m_users.user_id 
                                        join t_channel_messages on h_chmessage_replies.chmsg_id=t_channel_messages.chmsg_id")
